...
An example of a recent ethical submission document can be found [here in English](WEAVE_IFC_NL_HIRUZ_ENG_WF_HIRUZ_naMEC_clean.docx) and [here in Dutch](WEAVE_IFC_NL_HIRUZ_NL_HIRUZ_WF_naMEC_clean.docx).
...
The price calculator and a PDF document with the current prices (2026) are updated and available on the [Rates & Hours](https://gifmi.ugent.be/en/rates-booking) page on the website. Please note that prices are subject to indexation (e.g. +3.5% effective from 01/01/2026).

### *Newsletters from CORE GIfMI* 
Here is the list of newsletters with important news and information from CORE GIfMI:
- [Newsletter January 2026](https://github.com/fMRI-ugent/starting-a-new-fMRI-project/blob/8df99a4f1f3242a21c447ff2437ac15b05a289fb/Newsletters/COREGIfMI-NewsletterJanuary2026.pdf)  
